...
const ShopSettingWindow = () => {
  ...
  return (
    ...
    <div className="shop-date-picker-container">
      <label htmlFor="shop-holidays">Update Shop Closing Dates</label>
      <input 
        type="date" 
        name="holiday" 
        id="holiday" 
    ...
    <div className="shop-date-picker-container">
      <label htmlFor="shop-holidays">Update Shop Opening time</label>
      <input 
        type="time" 
        name="holiday" 
        id="holiday" 
    ...
    <div className="shop-date-picker-container">
      <label htmlFor="shop-holidays">Update Shop closing time</label>
      <input 
        type="time" 
        name="holiday" 
        id="holiday" 
