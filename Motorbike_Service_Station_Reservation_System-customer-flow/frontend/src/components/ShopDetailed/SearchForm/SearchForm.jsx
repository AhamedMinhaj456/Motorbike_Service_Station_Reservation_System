        ...
        <Container>
            <Form className='search-form d-lg-flex align-items-center justify-content-center mx-auto p-4 mt-4 mt-lg-0 z-2 rounded'>
                <div className='col-lg-2'>
                    <Form.Select>
                        <option>Search Fault</option>
                        <option value="1">Flat Tires</option>
                        <option value="2">Worn Tires</option>
                        <option value="3">Untrue Wheel</option>
                        <option value="3">Chain Issuesl</option>
                        <option value="3">Chain Issuesl</option>
                    </Form.Select>
                </div>
